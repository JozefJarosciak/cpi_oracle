...
const MIN_OBSERVATION_SECONDS = parseInt(process.argv[4]) || 120; // Wait 6+ minutes to see clear trend
const EXIT_WINDOW_START = 90; // Start checking for exit at 90s remaining
